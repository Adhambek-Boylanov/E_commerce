...
from configapp.filters import ProductFilter
from configapp.serializers import *
from configapp.models import *
from configapp.permissions import IsStaffOrReadOnly
...
class ProductViewSet(ModelViewSet):
    ...
    def average_rating(self,request,pk = None):
        ...
        avg_rating = sum([item.rating for item in reviews]) / reviews.count()
        return Response({
